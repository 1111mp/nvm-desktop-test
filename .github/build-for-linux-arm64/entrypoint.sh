...
if [ "$INPUT_TARGET" = "aarch64-unknown-linux-gnu" ]; then
    ...
    apt-get update
		apt-get install -y gcc-aarch64-linux-gnu g++-aarch64-linux-gnu libssl3:arm64
    ...
    export CXX_aarch64_unknown_linux_gnu=aarch64-linux-gnu-g++
		export PKG_CONFIG_SYSROOT_DIR=/usr/aarch64-linux-gnu/:/usr/lib/aarch64-linux-gnu/pkgconfig
