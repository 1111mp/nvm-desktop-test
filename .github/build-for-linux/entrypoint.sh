...
if [ "$INPUT_TARGET" = "x86_64-unknown-linux-gnu" ]; then
    ...
    sudo apt-get install -y --no-install-recommends g++-aarch64-linux-gnu libc6-dev-arm64-cross curl:arm64 wget:arm64 file:arm64 libglib2.0-dev:arm64 libwebkit2gtk-4.1-dev:arm64 libxdo-dev:arm64 build-essential:arm64 libssl-dev:arm64 libappindicator3-dev:arm64 libgtk-3-dev:arm64 patchelf:arm64 librsvg2-dev:arm64 libayatana-appindicator3-dev:arm64
